...
> for patient-specific hip fracture risk screening.*
...
> *Finite element derived femoral strength is a better predictor of hip
...
> Model for an Anthropomorphic Test Device Used in Underbody Blast
> Scenarios.*
...
> **Annals of Biomedical Engineering** 45 (5), 1247-1254, 2017

## Conference Presentations

*(Only oral presentations included; only first and senior authors
included)*

1.  **AM Baker**, A Fung, D Jha, H Pálsson, E Schileo, F
    Taddei, SJ Ferguson, B Helgason.

> *Sideways-Fall Finite Element Derived Critical Velocity Classifies Hip
> Fracture Risk in a Clinical Cohort.*
> **European Society of Biomechanics**, Edinburgh, UK, 2024

2.  **AM Baker**, A Della Casa, L Ellingsen, K Greene, A
    Weaver, D Houston, S Ferguson, B Helgason.

> *Predicting Bone Strength Loss Using Voxel-Based Morphometry and
> Finite Element Modeling.*
> **European Society of Biomechanics**, Maastricht, Netherlands, 2023

3.  A Della Casa, L Ellingsen, K Greene, A Weaver, D Houston, S
    Ferguson, B Helgason, **AM Baker**

> *Quantifying Sex-Related Changes of Bone Mass in Clinical Trial CT
> Scans Using Voxel-Based Morphometry*
> **European Society of Biomechanics**, Maastricht, Netherlands, 2023

4.  **AM Baker**, I Fleps, P Guy, S Ferguson, B Helgason.

> *Investigation of Limited CT Scan Coverage in Biofidelic Sideways-Fall
> Models for Clinical Cohorts.*
> **European Society of Biomechanics**, Porto, Portugal, 2022

5.  **AM Baker**, FC Hsu, R Salzar, E Spratley, L Voo, FS
    Gayzik.

> *Evaluation of Four Strategies to Decrease Normalized Confidence
> Interval Size of Injury Risk Curves.*
> **World Congress of Biomechanics**, Dublin, Ireland, 2018

6.  **AM Baker**, J Hendricks, A Weaver, E Spratley, R
    Salzar, C Bass, L Voo.

> *Scaling Effects on Injury Risk Curves for Femoral Mid-Shaft Bending
> Fracture.*
> **World Congress of Biomechanics**, Dublin, Ireland, 2018

7.  **AM Baker**, J Schap, N Vavalle, R Arminger, R
    Coates, FS Gayzik.

> *Multi-scale Validation of a Butyl Rubber Neck Model for an
> Anthropomorphic Testing Device Designed for Underbody Blast.*
> **LSTC Users Conference**, Dearborn, MI, USA, 2018

8.  **AM Baker**, FC Hsu, FS Gayzik.

> *A Novel Method of Estimating AROC using an Injury Risk Curve for
> Biomechanical Injury Metric Selection.*
> **Association for the Advancement of Automotive Medicine**, Las Vegas,
> NV, USA, 2017
